...
const Footer = () => {
    ...
    const socialLinks = [
        { name: 'LinkedIn', url: 'https://www.linkedin.com/in/mathulan-sritharan', icon: <FaLinkedin /> },
        { name: 'GitHub', url: 'https://github.com/Mathulan29', icon: <FaGithub /> },
        { name: 'Email', url: 'mailto:srimathulan@gmail.com', icon: <FaEnvelope /> },
    ];

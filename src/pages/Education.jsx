    ...
    const education = [
        {
            ...
            period: "2023 - Present",
            description: "Focused on software development, programming, and system design, exploring how these areas interconnect. Includes rigorous practical sessions and projects, enhancing theoretical knowledge with real-world application and hands-on experience.",
            courses: [
            ...
            achievements: [
                "Successfully delivered multiple full-stack development projects",
                "High performance in software design and architecture modules",
                "Actively contributed to open-source and team-based coding projects"
            ]
        },
    ];

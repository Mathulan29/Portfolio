    ...
    const projects = [
        {
            id: 1,
            title: "BookHive",
            description: "Built BookHive, a web platform to boost book accessibility in Sri Lanka via lending, borrowing, and selling",
            image: img3,
            tech: ["React", "Springboot", "PostgreSql", "Tailwind Css", "REST API", "JWT"],
            link: "https://github.com/Benshekniel/BookHiveFrontend",
            category: "web"
        },
        {
            id: 2,
            title: "GymOrbit",
            description: "Developed GymOrbit, a web platform to streamline gym management for members, instructors, and owners).",
            image: img4,
            tech: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
            link: "https://github.com/BSathurshan/Gym_Orbit",
            category: "web"
        },
        {
            id: 3,
            title: "Moonlit Devs - Library Management System",
            description: "Developed a library management system with key features including login/logout, account creation, password recovery, student management, book management, and issuing/returning books",
            image: img2,
            tech: ["javaFX", "Java", "MySQL"],
            link: "https://github.com/BSathurshan/Moonlit-Devs",
            category: "web"
        },
    ];

...
Your Portfolio Website`);
        ...
        // Create email URL
        const emailUrl = `mailto:srimathulan@gmail.com?subject=${emailSubject}&body=${emailBody}`;
                ...
                >
                        ...
                        <div className="space-y-6">
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400">srimathulan@gmail.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-400">Jaffna, Sri Lanka</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <a href="https://www.linkedin.com/in/mathulan-sritharan" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-all duration-200 group">
                            ...
                            <a href="https://github.com/Mathulan29" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-all duration-200 group">
                            ...
                            <a href="mailto:srimathulan@gmail.com" className="flex items-center space-x-3 p-4 rounded-lg bg-gray-700 hover:bg-gray-600 transition-all duration-200 group">

...
export default function Home() {
    ...
    const fullName = "Mathulan";

    const skills = [
        'React', 'JavaScript', 'Springboot', 'java', 'php', 'SQL', 'Git', 'HTML', 'CSS', 'Tailwind CSS', 'MySQL'
    ];
                ...
                <div className="lg:w-1/2 w-full flex items-center justify-center px-6 py-20">
                    <div className="max-w-2xl space-y-8">
                        <div className="space-y-6">
                            ...
                            >
                                "I craft modern, scalable, and impactful software solutions. With a focus on elegant architectures and data-driven insights, I turn complex problems into seamless digital experiences."
                            </motion.p>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <p className="text-gray-300 text-lg leading-relaxed font-light tracking-wide">
                            I'm a passionate and driven Information Systems student in University of Colombo School of Computing. With hands-on experience in full-stack development, Software Engineering, I specialize in building scalable, user-focused solutions using technologies. I’m always eager to bridge theory and practice in creative, impactful ways.
                        </p>
